...
export default class Research extends Scene {
  ...
  private readonly _energyRectangles: Map<
    ...
    Phaser.GameObjects.Rectangle
  > = new Map();
  private service: IResearchService;

  constructor(@inject("IResearchService") _researchService: IResearchService) {
    super("Research");
    this.service = _researchService;
  }
  ...
  private _drawGrid() {
    ...
    console.log(this._researchService.getLevel("3.2"));
  }
}
